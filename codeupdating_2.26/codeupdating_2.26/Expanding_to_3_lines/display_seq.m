...
function  display_seq(sequence,minlen_seq)
  num_encode = [1,2,3,4,5,6,7,8,10,11,12,13,14,15,16,18,19,20,21,22,23,24]; % the number way for encoding
  symbol_encode = [1-1i,2-1i,2+1i,3-1i,3+1i,4-1i,4+1i,1+1i,6-1i,6+1i,7-1i,7+1i,8-1i,8+1i,1+1i,...
                10-1i,10+1i,11-1i,11+1i,12-1i,12+1i,1+1i]; % the symbol way for encoding
  char_encode = {'1-','2-','2+','3-','3+','4-','4+','1+','6-','6+','7-','7+','8-','8+','1+','10-','10+','11-','11+','12-','12+','1+'};
  display_mode = 1;
