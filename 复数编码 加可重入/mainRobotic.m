...
N=14; %需求节点数
ET=[0 30 45 30 45];
%加工时间 设置30，80为第一工序和第二工序的加工时间

EL=[2000 2000 2000 2000 2000 2000 2000];%2000在这里代表无限大，即无时间窗
% ELL=EL-ET;%时间窗大小

[R,minlen,length_ave,length_best]=GA_Robotic(D,C,n,N,Pc,Pm,EL,ET);%主算法函数
